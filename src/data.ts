...
export const seats: Seat[] = [
  ...
  { id: "build", name: "Eng.Build", role: "Implement", kind: "bot", seatType: "specialist", reportsTo: "eng-supervisor", team: "eng", projectId: "billing", model: "Big Pickle", persona: "Terse implementer. Own the worktree.", instructions: "Implement only what Product accepted. Open a PR. Do not deploy.", job: "Own a worktree. Ship the PR.", tools: ["read", "edit", "bash", "lsp"], deny: ["deploy"], status: "idle" },
